package ru.mail.vera.ui.views.storefront;

import static ru.mail.vera.ui.utils.FormattingUtils.HOUR_FORMATTER;
import static ru.mail.vera.ui.utils.FormattingUtils.MONTH_AND_DAY_FORMATTER;
import static ru.mail.vera.ui.utils.FormattingUtils.SHORT_DAY_FORMATTER;
import static ru.mail.vera.ui.utils.FormattingUtils.WEEKDAY_FULLNAME_FORMATTER;
import static ru.mail.vera.ui.utils.FormattingUtils.WEEK_OF_YEAR_FIELD;

import java.time.LocalDate;
import java.util.List;

import com.vaadin.flow.data.renderer.TemplateRenderer;
import ru.mail.vera.backend.data.entity.Order;
import ru.mail.vera.backend.data.entity.OrderItem;
import ru.mail.vera.backend.data.entity.OrderSummary;
import ru.mail.vera.ui.utils.converters.OrderStateConverter;
