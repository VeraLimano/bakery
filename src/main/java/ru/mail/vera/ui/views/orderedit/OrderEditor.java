...
import static ru.mail.vera.ui.dataproviders.DataProviderUtil.createItemLabelGenerator;
...
import ru.mail.vera.backend.data.OrderState;
import ru.mail.vera.backend.data.entity.Order;
import ru.mail.vera.backend.data.entity.PickupLocation;
import ru.mail.vera.backend.data.entity.Product;
import ru.mail.vera.backend.data.entity.User;
import ru.mail.vera.backend.service.PickupLocationService;
import ru.mail.vera.backend.service.ProductService;
import ru.mail.vera.ui.crud.CrudEntityDataProvider;
...
import ru.mail.vera.ui.views.storefront.events.ReviewEvent;
import ru.mail.vera.ui.views.storefront.events.ValueChangeEvent;
