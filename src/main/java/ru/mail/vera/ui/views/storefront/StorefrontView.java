...
import ru.mail.vera.app.HasLogger;
import ru.mail.vera.backend.data.entity.Order;
import ru.mail.vera.backend.data.entity.util.EntityUtil;
import ru.mail.vera.ui.MainView;
import ru.mail.vera.ui.components.SearchBar;
import ru.mail.vera.ui.utils.BakeryConst;
import ru.mail.vera.ui.views.EntityView;
import ru.mail.vera.ui.views.orderedit.OrderDetails;
import ru.mail.vera.ui.views.orderedit.OrderEditor;

import static ru.mail.vera.ui.utils.BakeryConst.EDIT_SEGMENT;
import static ru.mail.vera.ui.utils.BakeryConst.ORDER_ID;
